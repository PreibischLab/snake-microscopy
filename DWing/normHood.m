...
function [normedHoodCont, normedHoodCur, normedHoodTempMatch]  = normHood(Xs, Ys, p, hoodSize, averageDist, corrImage)
    ...
    % template match matrix 
    normedHoodTempMatch = corrImage(x-hoodSize:x+hoodSize, y-hoodSize:y+hoodSize);    
